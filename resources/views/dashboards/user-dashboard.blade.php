                            ...
                            <ul class="p-0 m-0 mb-2 swiper-wrapper list-inline">
                                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                                    <div class="card-body">
                                        <div class="progress-widget">
                                            <div>
                                                <i class="fs-1 text-black bi bi-arrow-down-short"></i>
                                            </div>
                                            <div class="progress-detail">
                                                <p class="mb-2">Money In</p>
                                                <h4 class="counter color-1"><i class="bi bi-currency-rupee"></i>197</h4>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="800">
                                    <div class="card-body">
                                        <div class="progress-widget">
                                            <div>
                                                <i class="fs-1 text-black bi bi-arrow-up-short"></i>
                                            </div>
                                            <div class="progress-detail">
                                                <p class="mb-2">Money Out</p>
                                                <h4 class="counter color-1"><i class="bi bi-currency-rupee"></i>197
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="900">
                                    <div class="card-body">
                                        <div class="progress-widget">
                                            <div>
                                                <i class="rotate-icon1 fs-1 text-black bi bi-arrow-up-short"></i>
                                            </div>
                                            <div class="progress-detail">
                                                <p class="mb-2">BUY NOW PAY LATER</p>
                                                <h4 class="counter color-1"><i class="bi bi-currency-rupee"></i>0
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1000">
                                    <div class="card-body">
                                        <div class="progress-widget">
                                            <div>
                                                <i class="rotate-icon2 fs-1 text-black bi bi-arrow-down-short"></i>
                                            </div>
                                            <div class="progress-detail">
                                                <p class="mb-2">CREDIT DUE</p>
                                                <h4 class="counter color-1"><i class="bi bi-currency-rupee"></i>0
                                                </h4>
                                            </div>
                                        </div>
